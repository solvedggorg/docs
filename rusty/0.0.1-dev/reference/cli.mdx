...
```bash
rusty init [name] [--kind KIND | -cli|-web|-tui|-lib|-fullstack|-blank] [--format cargo|rusty] [--edition YYYY] [-y]
```

| Flag | Meaning |
| --- | --- |
| `name` | Package name (default: current directory name when non-interactive) |
