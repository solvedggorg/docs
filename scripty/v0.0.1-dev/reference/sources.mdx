...
| **Bun version for inventory** | *Track latest stable at last inventory pass; record version when freezing B-0* |
...
| **Deno version for inventory** | *Track latest stable at last inventory pass; record version when freezing D-0* |
| **Last inventory review** | 2026-07-17 (initial program docs) |
...
| Lock | Reference |
| --- | --- |
| Own VM (no V8/JSC/SM) | AGENTS / v1 plan D1 |
| Linux only | D5 |
